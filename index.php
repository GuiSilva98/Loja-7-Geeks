...
//Caso não, ele cria um id temporário para o mesmo 
if(empty($_SESSION['txtnome'])){
if(empty($_SESSION['cod_cliente'])){
	$comando = "SELECT MAX(cod_cliente_temp) AS total FROM user_temp";
	$incluir = mysqli_query($conexao, $comando); 
	$contagem = mysqli_fetch_array($incluir);
	$soma = $contagem[0] + 1;
	$var = 'cliente' + $soma;
	$comando2 = "INSERT INTO user_temp(nome_cliente_temp) VALUES ('$var')";
	$incluir2 = mysqli_query($conexao,  $comando2);
	$_SESSION['cod_cliente'] = $soma;
	}
}
?>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="imagens/Slide Rotativo/banner1.jpg" alt="Teste" />
        <div class="carousel-caption">
            
        <h3>Coleção de bonecos</h3>
            <a href="#">
        <p>Confira!</p></a>
      </div>
    ...
    <div class="item">
      <img src="imagens/Slide Rotativo/banner2.jpg" alt="Star Wars">
    </div>
	
	<div class="item">
      <img src="imagens/Slide Rotativo/bannerlixo.jpg" alt="Star Wars">
    </div>
...
<!--- Conteúdo -->
<br>
<h1 id="preto">Destaques da loja!</h1>
<?php
include "conexao.php";
