...
<br />
            ...
            <div class="col-md-9">
        <div class="col-md-3">
            <div class="thumbnail"><br><a href="inserirproduto.php"><img src="../../imagens/oipedidinhos.png">
                <div class="caption">
                    <h3>Inserir<br>Produtos</h3>
                </div>
            </div>
        </div>
		
		<div class="col-md-3">
            <div class="thumbnail"><br><a href="excluirproduto.php"><img src="../../imagens/tchaupedidinhos.png">
                <div class="caption">
                    <h3>Excluir<br>Produtos</h3>
                </div>
            </div>
        </div>
        
            <div class="col-md-3">
            <div class="thumbnail"><br><a href="relatorio/relatoriocombanco.php"><img src="../../imagens/contrariodoadeuspedinhos.png">
                <div class="caption">
                    <h3>Relatorio de<br>Produtos</h3>
                </div>
            </div>
        </div>
