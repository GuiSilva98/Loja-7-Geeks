...
<br />
            ...
            <div class="col-md-9">
            <div class="col-md-3">
            <div class="thumbnail"><br><a href="user/user.php"><img src="../imagens/usuarinhoo.png">
                <div class="caption">
                    <h3>Usuarios</h3>
                   </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="thumbnail"><br><a href="produtos/produtos.php"><img src="../imagens/meus-pedidos.png">
                <div class="caption">
                    <h3>Produtos</h3>
                </div>
            </div>
		...
		<div class="col-md-3">
            <div class="thumbnail"><br><a href="pedidos/pedidos.php"><img src="../imagens/pedidinhos.png">
                <div class="caption">
                    <h3>Pedidos</h3>
                </div>
            </div>
