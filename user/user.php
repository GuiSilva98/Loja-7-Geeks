...
<br />
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         <ul class="list-group">
                            ...
                            <li class="list-group-item"><span><a href="user.php">Usuarios</a></span>
            ...
            <div class="col-md-9">
            <div class="col-md-3">
            <div class="thumbnail"><br><a href="alluser.php"><img src="../../imagens/usuarinhoo.png">
                <div class="caption">
        ...
        <div class="col-md-3">
            <div class="thumbnail"><br><a href="cadadm.php"><img src="../../imagens/bomdiausuario.png">
                <div class="caption">
		...
		<div class="col-md-3">
            <div class="thumbnail"><br><a href="excluiradm.php"><img src="../../imagens/tchauusuario.png">
                <div class="caption">
