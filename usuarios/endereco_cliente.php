...
<title>Endereço de entrega - 7Geeks</title>
...
<br />
			...
			?>
			<p>
			<button class="btn btn-primary submit-button" type="button" name="botao" onclick="window.open('alterarenderecocliente.html#dados', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=350, WIDTH=770, HEIGHT=650');" id="botao">Alterar Endereço</button>
			</p>
			</form>
            </div>
          </div>
