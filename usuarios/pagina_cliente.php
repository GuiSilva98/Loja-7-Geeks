...
<br />
            ...
            <div class="col-md-9">
            <div class="col-md-3">
            <div class="thumbnail"><br><a href="dados_cliente.php"><img src="../imagens/meus-dados.png">
                <div class="caption">
                    <h3>Dados<br>da Conta</h3>
                   </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="thumbnail"><br><a href="pedidos.php"><img src="../imagens/meus-pedidos.png">
                <div class="caption">
                    <h3>Meus <br> Pedidos</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="thumbnail"><br><a href="endereco_cliente.php"><img src="../imagens/meus-endereços.png">
                <div class="caption">
                    <h3>Meus <br> Endereços</h3>
                </div>
            </div>
            </div>
