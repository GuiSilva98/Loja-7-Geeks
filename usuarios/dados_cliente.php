...
<br />
			...
			?>
			<p>
			<button class="btn btn-primary submit-button" type="button" name="botao" onclick="window.open('alterardadoscliente.html#dados', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=350, WIDTH=770, HEIGHT=650');" id="botao">Alterar dados</button>
			<button class="btn btn-primary submit-button" type="button" name="botao" onclick="window.open('alterarsenhacliente.html#senhas', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=center, LEFT=center, WIDTH=400, HEIGHT=500');" id="botao">Alterar Senha</button>
			</p>
			</form>
            </div>
          </div>
